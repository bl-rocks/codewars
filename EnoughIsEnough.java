 ...
 * the answer would be [1,2,1,2,] drop the next[1,2] since this would lead to 1 and 2 being in the 
 * result 3  times which would be break initial requirements --> #times_in_result_array < N.
 ###### UPDATED 8/15/24 BY: BRIAN LAWS
 ###### only changes to comments made
 */
